...
from ..base_objects import BaseBox, BaseMesh, BaseURDF, ObjectProperties


class _GenesisPoseMixin:
...
class GenesisBox(_GenesisPoseMixin, BaseBox):
    def __init__(
...
class GenesisURDF(_GenesisPoseMixin, BaseURDF):
    def __init__(
        self, gs_scene: gs.Scene, properties: ObjectProperties, device: th.device
    ):
        super().__init__(properties=properties, device=device)
...
class GenesisMesh(_GenesisPoseMixin, BaseMesh):
    def __init__(
        self, gs_scene: gs.Scene, properties: ObjectProperties, device: th.device
    ):
        super().__init__(properties=properties, device=device)
